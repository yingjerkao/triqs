  ...
  */
   ...
   */
    ...
    class MAKO_GF :
      ...
      struct impl_tag {};
      template <typename G> MAKO_GF(impl_tag, G &&x) : _block_names(x.block_names()), _glist(factory<data_t>(x.data())), name(x.name) {}
   ...
   */
    ...
    */
    ...
    template <typename Gf> block2_gf_MAKO_VIEW_of<Gf> make_block2_gf_MAKO_VIEW(std::vector<std::vector<Gf>> &v) {
      static_assert(Gf::is_view);
    ...
    block2_gf_MAKO_VIEW_of<Gf> make_block2_gf_MAKO_VIEW(std::vector<std::string> block_names1, std::vector<std::string> block_names2,
